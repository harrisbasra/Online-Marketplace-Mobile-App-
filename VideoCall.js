...
const VideoCall = () => {
  return (
    <View style={styles.videoCall}>
      ...
      <View style={[styles.videoCallItem, styles.textPosition]} />
      <View
        style={[
          styles.lineParent,
          styles.parentFlexBox,
      ...
      >
        ...
        <View style={[styles.topNotchFlexBox, styles.mt24]}>
          ...
          >
            <Image
              style={styles.micOffIcon}
              resizeMode="cover"
              source={require("../cameraoff@3x.png")}
            />
          </View>
          <View
            style={[
          ...
          >
            <Image
              style={styles.micOffIcon}
              resizeMode="cover"
              source={require("../refreshccw1@3x.png")}
            />
          </View>
          <View
            style={[styles.xWrapper, styles.ml40, styles.wrapperSpaceBlock]}
          >
            <Image
              style={styles.micOffIcon}
              resizeMode="cover"
      ...
      <Text style={[styles.text, styles.textPosition]}>00:58</Text>
    </View>
  );
};
...
const VideoCallScreen = () => {
  ...
  const switchCamera = () => {
    localStreamRef.current.getVideoTracks()[0].switchCamera();
    setIsFront(!isFront);
  };
