...
const NormalCall = () => {
  return (
    <View style={styles.normalCall}>
      <View style={[styles.topNotch, styles.borderPosition]}>
        <View style={[styles.timeWrapper, styles.timeWrapperFlexBox]}>
          <Image
            style={styles.timeIcon}
            resizeMode="cover"
            source={require("../time1@3x.png")}
          />
        </View>
        <View
      ...
      <View style={styles.frameParent}>
        ...
        <View style={[styles.frameGroup, styles.mt40]}>
          <View style={[styles.micOffWrapper, styles.wrapperSpaceBlock]}>
            <Image
              style={styles.micOffIcon}
              resizeMode="cover"
      ...
      <View style={[styles.xWrapper, styles.wrapperSpaceBlock]}>
        <Image
          style={styles.micOffIcon}
          resizeMode="cover"
